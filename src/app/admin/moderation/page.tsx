...
import { useAdminModerationData, type Report } from "@/hooks/useAdminModerationData";
...
export default function ModerationPage() {
  const { data, loading } = useAdminModerationData();
  const [reports, setReports] = useState<Report[]>(data.reports);
