  ...
  return (
    ...
    >
      ...
      <motion.section variants={item}>
        <div className="rounded-2xl border border-white/5 bg-card p-5 md:p-6">
          <div className="flex flex-col sm:flex-row items-start gap-5">
            {/* Avatar */}
            <div className="relative shrink-0">
              <div className="size-20 md:size-24 rounded-2xl bg-gradient-to-br from-[#D4A843] to-[#B8922E] flex items-center justify-center text-4xl md:text-5xl font-bold text-black">
                T
              </div>
              ...
              <div className="rounded-xl border border-white/5 bg-card p-5 space-y-5">
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="font-heading font-bold text-4xl text-[#D4A843]">
                      78
                    </span>
                ...
                <div className="rounded-lg border border-[#D4A843]/20 bg-[#D4A843]/5 p-4 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    untuk masuk radar scouting pro team.
                  </p>
